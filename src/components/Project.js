...
function Project() {
    return (
        <div id="projects" className="projects__wrapper">
            ...
            <ProjectItem github="" weblink="" technologies={["React JS","Django","Python","Html","Css"]} title="Netflix Clone" description="A Simplified clone of Netflix. It was created with ReactJS ,Django and MovieDB API on some parts of the Application. Checkout my Netflix Frontend blog on this Here "/>
            ...
            <ProjectItem github="https://github.com/priyaljain03/portfolio" weblink="" technologies={["React JS","Html","CSS"]} title="Portfolio" description="My personal website . Designed and developed in a way to avoid use of frameworks like Bootstrap."/>
